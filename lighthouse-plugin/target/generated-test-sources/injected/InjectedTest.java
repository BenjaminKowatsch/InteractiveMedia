...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:lighthouse-plugin:0.1");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/home/benny/Dokumente/lighthouse-plugin");
    parameters.put("artifactId","lighthouse-plugin");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/home/benny/Dokumente/lighthouse-plugin/target/classes");
    parameters.put("testOutputDirectory","/home/benny/Dokumente/lighthouse-plugin/target/test-classes");
