...
describe('Get groups', function() {
    ...
    before(function(done) {
        ...
        chai.request(host)
            .post(loginUrl)
            .send({username: testData.users.valid[2].username, password: testData.users.valid[2].password})
            .then(function(res) {
    ...
    it('should respond with 403 if all groups are accessed as nonAdmin', function() {
