...
public class Login {
  ...
  public void uploadUnsyncedTransactions(final Context context) {
    final List<Transaction> transactions = helper.getUnsyncedTransactions(user.getUserId());
  ...
  public void uploadUnsyncedGroups(final Context context) {

    final List<Group> groups = helper.getUnsyncedGroups(user.getUserId());
